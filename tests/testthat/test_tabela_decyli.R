test_that("Tabela_decyli przyjmuje 4 argumenty i zwraca obiekt ramke danych",{
  ...
  expect_is(tabela_decyli(jeden,dwa,trzy,"CosTam"),"data.frame")
  expect_error(tabela_decyli(jeden,dwa,"CosTam"))
})